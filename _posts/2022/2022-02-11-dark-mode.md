...
categories: [Software, Web Development, Personal]
image: content/images/test_pattern.jpg
image_alt: A television color bar test pattern in the SMPTE style, with bright saturated bars above rows of darker blocks.
---
