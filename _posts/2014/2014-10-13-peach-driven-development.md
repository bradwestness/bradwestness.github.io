...
![http://en.wikipedia.org/wiki/File:Overview_of_a_three-tier_application_vectorVersion.svg]({{ '/content/images/' | relative_url }}business_logic.png)
...
![peach and earth]({{ '/content/images/' | relative_url }}peach_earth.jpg)
